...
6. **编写设计文档** — 保存到 `{项目空间（如果已提供则优先） | 工作空间（备份选项）}/docs/zjkycode/specs/YYYY-MM-DD-<topic>-design.md` 并提交
...
- 将验证过的设计（规范）写入 `{项目空间（如果已提供则优先） | 工作空间（备份选项）}/docs/zjkycode/specs/YYYY-MM-DD-<topic>-design.md`
  - （用户对规范位置的偏好会覆盖此默认值）
