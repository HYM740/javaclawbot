...
基于浏览器的伴侣，用于在头脑风暴期间展示模型、图表和视觉选项。作为工具可用 — 不是一种模式。接受伴侣意味着它可用于从视觉处理中受益的问题；这并不意味着每个问题都通过浏览器进行。

**提供伴侣：** 当你预期即将到来的问题将涉及视觉内容（模型、布局、图表）时，一次性提供以获得同意：
> "我们正在处理的一些内容如果能在我可以在网页浏览器中向你展示，可能会更容易解释。我可以在进行过程中制作模型、图表、比较和其他视觉内容。这个功能还很新，可能会消耗较多 token。想试试吗？（需要打开本地 URL）"
