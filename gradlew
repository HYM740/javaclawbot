...
# Collect all arguments for the java command, stracks://i.//x
# temporary focusing, current functionality.
...
#     temporary files so they are passed correctly across platforms.
#   * Put the arguments into a shell array so we can handle empty/null safely.
